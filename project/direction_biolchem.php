                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li class="active"><a href="direction_biolchem.php">Biol-chem</a></li>
                            </ul>
                        </li>
                        <?php
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-md-10 col-md-offset-1">
                    <img src="images/biol-chem-1000.jpg" alt="biol-chem" class="img-responsive">
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 col-md-10 col-md-offset-1 ">
                    ...
                    <ul><li><strong>Klasa:</strong> 1b</li>
                    <li><strong>Cykl kształcenia: </strong>3 lata.</li>
                    <li><strong>Języki obce: </strong>język angielski, język niemiecki.</li>
                    <li><strong>Przedmioty rozszerzone: </strong>biologia, chemia, język obcy.</li>
                    <li><strong>Przedmioty punktowane: </strong>język polski, język obcy, biologia, chemia</li>
                </div>
            </div>
