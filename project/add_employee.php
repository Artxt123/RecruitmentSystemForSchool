    ...
    <div id="wrap">
        ...
        <div class="container">
            <div class="col-md-10 col-md-offset-1">
                <form class="form-horizontal" action="add_employeeprocessing.php" method="POST">
                    <h2 class="form-signin-heading text-center">Rejestracja nowego pracownika</h2>
                    <?php
                    ...
                    <button class="btn btn-lg btn-primary btn-block" type="submit">Zarejestruj nowego pracownika</button>
                </form>
            </div>
        </div>
        <!-- /container -->
