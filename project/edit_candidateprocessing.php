...
if(validateEmail($_POST['email'])){
    header("Location: edit_candidate.php?errorNumber=1&email=" . $_POST['old_email']);
    exit();
}

//SPRAWDZENIE, CZY IMIĘ JEST PRAWIDŁOWE
if(validateName($_POST['name'])){
    header("Location: edit_candidate.php?errorNumber=8&email=" . $_POST['old_email']);
    exit();
}
...
if(validateDateFormat($_POST['birthday'])){
    header("Location: edit_candidate.php?errorNumber=9&email=" . $_POST['old_email']);
    exit();
}

//SPRAWDZENIE, CZY PESEL MA POPRAWNY FORMAT
if(validatePESEL($_POST['pesel'])){
    header("Location: edit_candidate.php?errorNumber=10&email=" . $_POST['old_email']);
    exit();
}

//SPRAWDZENIE, CZY NAZWA MIEJSCOWŚCI JEST POPRAWNA
if(validateAddress($_POST['city'])){
    header("Location: edit_candidate.php?errorNumber=11&email=" . $_POST['old_email']);
    exit();
}

//SPRAWDZENIE, CZY KOD POCZTOWY JEST POPRAWNY
if(validateZipCodePl($_POST['code'])){
   header("Location: edit_candidate.php?errorNumber=12&email=" . $_POST['old_email']);
    exit(); 
}
...
if(validateHouseNr($_POST['house_nr'])){
    header("Location: edit_candidate.php?errorNumber=13&email=" . $_POST['old_email']);
    exit();
}

//SPRAWDZENIE, CZY NUMER MIESZKANIA JEST POPRAWNY, MOŻE BYĆ PUSTY
if(validateApartmentNr($_POST['apartment_nr'])){
    header("Location: edit_candidate.php?errorNumber=14&email=" . $_POST['old_email']);
    exit();
}
...
if($stmt = $mysqli->prepare($update_logowanie)){
    ...
    header("Location: edit_candidate.php?errorNumber=2&email=" . $_POST['old_email']);
    exit();
}
        ...
        if($stmt = $mysqli->prepare($query_adresy)){
            ...
            if (empty($ID_ADRES_FROM_DATABASE)){
                ...
                if($stmt = $mysqli->prepare($update_adresy)){
                    ...
                    header("Location: edit_candidate.php?errorNumber=3&email=" . $_POST['old_email']);
                    exit();
                }
            } 
            ...
            header("Location: edit_candidate.php?errorNumber=5&email=" . $_POST['old_email']);
            exit();
        }
        ...
        if($stmt = $mysqli->prepare($query_adresy)){
            ...
            if (empty($ID_ADRES)){
                ...
                if($stmt = $mysqli->prepare($insert_adresy)){
                    ...
                    header("Location: edit_candidate.php?errorNumber=4&email=" . $_POST['old_email']);
                    exit();
                }
...
if((isset($ID_ADRES_FROM_DATABASE)) && (!empty($ID_ADRES_FROM_DATABASE))){
    ...
    if($stmt = $mysqli->prepare($update_kandydaci)){
        ...
        header("Location: edit_candidate.php?errorNumber=6&email=" . $_POST['old_email']);
        exit();
    }
    ...
    if($stmt = $mysqli->prepare($delete_adresy)){
        ...
        header("Location: edit_candidate.php?errorNumber=7&email=" . $_POST['old_email']);
        exit();
    }
...
header("Location: database_results.php?infoNumber=1");
exit();
