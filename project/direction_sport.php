                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li class="active"><a href="direction_sport.php">Klasa sportowa</a></li>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-md-10 col-md-offset-1">
                    <img src="images/sport-1000.jpg" alt="sport" class="img-responsive">
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 col-md-10 col-md-offset-1 ">
                    ...
                    <ul><li><strong>Klasa:</strong> 1e</li>
                    <li><strong>Cykl kształcenia: </strong>3 lata.</li>
                    <li><strong>Języki obce: </strong>język angielski, język niemiecki.</li>
                    <li><strong>Przedmioty rozszerzone: </strong>wychowanie fizyczne, biologia, wiedza o społeczeństwie.</li>
                    <li><strong>Przedmioty punktowane: </strong>język polski, język obcy, wychowanie fizyczne, biologia.</li>
                </div>
            </div>
